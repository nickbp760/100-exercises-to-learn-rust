mod ticket {
    ...
    // bilang ke orang2 kalau ada kotak bernama ticket tapi orang lain ga boleh tau isinya karena masih private semua

    impl Ticket {
        // kalau mau create ticket harus pakai new yang udah dibuat pub
...
mod tests {
    ...
    fn encapsulation_cannot_be_violated() {
        ...
        // let _ticketnew = Ticket::new(
        //     "My title".into(),
        //     "A proper description".into(),
        //     "To-Do".into(),
        // );
    }
}
